...
const Footer = () => {
    return (
        <div className="w-full min-h-fit mt-6">
            <h1 className="font-bold font-sans text-3xl md:text-4xl text-center mb-6"> <span className="text-red-400">j</span>obsy</h1>
            <div className="flex flex-col">
                <div className="w-1/3 mx-auto text-lg md:text-xl">
                    <h1 className="text-center">Copyright{"  "}&copy;{"  "}Jobsy, Inc. </h1>
                </div>
