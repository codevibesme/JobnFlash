...
const JobsPage = () => {
  return (
    <div className="flex h-full w-full bg-slate-200 px-8 pt-16">
      <form id="search" className="flex w-full min-h-fit rounded-lg bg-white">
        ...
        <button
          type="submit"
          className="rounded-lg w-1/3 text-lg md:text-3xl text-white bg-red-400 hover:scale-105 hover:shadow-md hover:shadow-red-500 md:w-1/5"
        >
          Find Job
        </button>
      </form>
