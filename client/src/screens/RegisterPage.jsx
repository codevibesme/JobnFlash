        ...
        <div className="relative bg-slate-200 flex flex-col justify-center min-h-screen overflow-hidden pt-10">
           ...
           <h1 className="text-3xl font-semibold text-center text-red-400 uppercase">
                    ...
                    <form className="mt-5" onSubmit={handleRegister}>
                        ...
                        <button type="submit" className="w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-red-500 rounded-md hover:bg-red-600 focus:outline-none focus:bg-red-600">
                            Register
                        </button>
                        </div>
                    </form>
                    ...
                    <button className="flex items-center justify-center w-full p-2 border border-gray-600 rounded-md focus:ring-2 focus:ring-offset-1 focus:ring-red-400">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 32 32"
                            className="w-5 h-5 fill-current"
